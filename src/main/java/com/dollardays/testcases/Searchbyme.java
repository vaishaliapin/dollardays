...
public class Searchbyme extends BaseTest{
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "SearchBar",  testcaseID = "TC2", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
...
//		searchpage.getSearchBar().sendKeys(datatable.get("Product Name"));
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "SearchBar",  testcaseID = "TC5", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
